...
No media types have been formally registered with IANA for the style encodings (Mapbox Styles, OGC SLD/SE or CartoSym CSS/JSON).
Temporary media types in the vnd-branch as specified below are used for now.

=== application/vnd.ogc.cartosym+json

* Type name:  application
* Subtype name:  vnd.ogc.cartosym+json
...
* Published specification:  link:https://docs.ogc.org/DRAFTS/18-067r4.html#rc-json[OGC Cartographic Symbology - Part 1: Core Model & Encodings (draft, Requirements Class "JSON Styles and Symbology")]
* Applications that use this media type:  Geographic information systems (GIS)
* File extension(s): .csjson, .cs.json, .json
* Intended usage:  COMMON
* Change controller: OGC

=== application/vnd.ogc.cartosym+css

* Type name:  application
* Subtype name:  vnd.ogc.cartosym+css
* Published specification:  link:https://docs.ogc.org/DRAFTS/18-067r4.html#rc-cscss[OGC Cartographic Symbology - Part 1: Core Model & Encodings (draft, Requirements Class "Cartographic Symbology Cascading Style Sheets")]
* Applications that use this media type:  Geographic information systems (GIS)
* File extension(s): .cscss
* Intended usage:  COMMON
* Change controller: OGC
