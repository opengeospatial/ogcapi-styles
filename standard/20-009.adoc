...
|Internal reference number of this OGC(R) document: 20-009
|Version: link:http://docs.opengeospatial.org/DRAFTS/20-009.html[1.0.0-draft.2 (Editor's draft)]

|Category: {category}
|Editors: Clemens Portele, Jérôme Jacovella-St-Louis
|===
...
|===
|*Copyright notice*
|Copyright (C) {copyrightYear} Open Geospatial Consortium
...
include::clause_8_global_styles.adoc[]

include::clause_9_collection_styles.adoc[]

include::clause_10_manage_styles.adoc[]

include::clause_11_validate_styles.adoc[]

include::clause_12_style_encodings.adoc[]
