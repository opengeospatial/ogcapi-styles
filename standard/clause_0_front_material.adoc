...
3. For each style, metadata can be provided within the style sheets themselves,
as well as in the style entry at `/styles`, with general descriptive
information about the style, the Geospatial Data Classes intended to be portrayed with the styles,
links to the schema(s) detailing the layers and attributes available,
...
|Clément Drouadaine |Institut National de l'Information Géographique et Forestière (IGN)
|===
