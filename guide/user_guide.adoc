:Title: OGC API - Styles Guide
:titletext: OGC API - Styles Guide
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    NN-NNN
...
include::section_6_introduction_to_portrayal.adoc[]
(done)

include::section_7_introduction_to_OpenAPI.adoc[]
(done)

include::section_8_ogcapi_styles.adoc[]
(done)
